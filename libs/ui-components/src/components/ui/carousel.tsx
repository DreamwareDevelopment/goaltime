...
>(({ className, dir, children, ...props }, ref) => {
  ...
  return (
    <div {...props} ref={thumbsRef} className={cn("overflow-hidden h-full", className)} dir={direction}>
      <div
        ref={ref}
        className={cn(
          "flex",
...
>(({ className, index, color, children, onButtonClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square h-20 w-full opacity-75 hover:opacity-90 rounded-md transition-opacity ${
